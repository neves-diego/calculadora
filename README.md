Se você precisa fazer contas sem sair do terminal, encontrou a solução. Esta calculadora em Bash faz o básico com eficiência: soma, subtração, multiplicação e divisão. Tudo direto no prompt.
